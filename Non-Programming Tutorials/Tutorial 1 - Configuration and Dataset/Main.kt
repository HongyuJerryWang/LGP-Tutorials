...
class Arguments(parser: ArgParser) {
    ...
    ).default("src/main/kotlin/lgp/tutorial/linearRegression/configuration.json").addValidator {
        val usingDefault = value == "src/main/kotlin/lgp/tutorial/linearRegression/configuration.json"
        println("Using ${if (usingDefault) "default" else "specified"} configuration file ($value)...")
    }
    ...
    ).default("src/main/kotlin/lgp/tutorial/linearRegression/linear-regression-experiment.csv").addValidator {
        val usingDefault = value == "src/main/kotlin/lgp/tutorial/linearRegression/linear-regression-experiment.csv"
        println("Using ${if (usingDefault) "default" else "specified"} data set file ($value)...")
    }
...
class Main {
    companion object Main {
        ...
        private fun runExperiment() {
            val problem = LinearRegressionExperiment(
            ...
            File("linear_regression_experiment.c").bufferedWriter().use { out ->
