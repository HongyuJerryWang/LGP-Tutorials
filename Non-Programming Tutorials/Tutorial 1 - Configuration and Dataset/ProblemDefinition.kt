...
class LinearRegressionExperiment(
    ...
    override val name = "Linear Regression Experiment"
    override val description = Description(
        "An example linear regression problem definition for the LGP tutorial."
    )
    ...
    override fun solve(): LinearRegressionExperimentSolution {
        ...
        return LinearRegressionExperimentSolution(
            problem = this.name,
