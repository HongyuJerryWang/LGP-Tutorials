...
Please take a look at the files generated by the program: **results.csv**, **testcases.txt** and **time_series_experiment.c**. Feel free to compare your results to the results in this repository, and compile and run the C program. Please refer to Tutorial 2 for how to tweak the hyperparameters and the evolutionary algorithm.
